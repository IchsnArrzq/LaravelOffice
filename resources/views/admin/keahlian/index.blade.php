    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex flex-row justify-content-between">
                ...
                <a href="{{ route('admin.keahlian.create') }}" class="btn btn-sm btn-primary">Create New</a>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-striped" id="datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('admin.keahlian.edit', $data->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                        <form action="{{ route('admin.keahlian.destroy', $data->id) }}" method="post">
                                            @csrf
                                            @method('delete')
