    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex flex-row justify-content-between">
                ...
                <a href="{{ route('admin.agama.create') }}" class="btn btn-sm btn-primary">Create New</a>
            </div>
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <form action="{{ route('admin.agama.destroy', $data->id) }}" method="post">
                                            @csrf
                                            @method('delete')
